Библиотека версионной миграции структурированных данных в C/C++. Для изменением этих структур без потерь сохраненных данных при обновлениях программного обеспечения.
