...
int main(const int argc, const char *argv[]) {
	...
	if (MigrateData::Run(0xFFFFFFFF, TestData::V00000003::DataMigrate.Version, &DataMigrateItems, &storedSettings, sizeof(storedSettings), &settingsV00000003,
						 onMigrateDataItem)
		!= MigrateRes_Migrate) {
		return EXIT_FAILURE;
	}
	if (settingsV00000003.Data0 != 0) {
		return EXIT_FAILURE;
	}
